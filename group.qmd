...
ggplot(polling_err, aes(x = reorder(party_code, avg_err), y = avg_err, color = factor(party_code))) +
  geom_point(size = 3) +  
...
# Either plot avg polling error by party or dynamically by party and election
# Plot polling error vs turnout/turnout difference?
