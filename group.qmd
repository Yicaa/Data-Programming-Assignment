...
#Relationship between census and vote
model <- lm(party_ballots ~ population, data = final_election2)
summary(model)
...
### 7. How consistent are the survey projections across different election periods? Identify trends or patterns in the prediction biases over time and analyze if certain parties consistently experience higher deviations.
