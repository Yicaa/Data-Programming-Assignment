...
low_turnout_threshold <- quantile(tidy_surveys$turnout, 0.25, na.rm = TRUE)
#Filter Low Turnout Data
low_turnout_data <- tidy_surveys%>%
  drop_na() |> 
  filter(turnout < low_turnout_threshold)
...
#data visualization
ggplot(low_turnout_summary, aes(x = reorder(party, -vote_share), y = vote_share, fill = party)) +
