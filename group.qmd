...
Election identifiers: 
  ...
  - General election information -> number_tables, participacion_1, participacion_2, blank_votes, null_votes, valid_votes, total_votes
...
turnout <- final_election |> 
  select(
    ...
    population, number_tables, participation_1, participation_2, 
...
We have 2 primary datasets at this stage, election data and survey data, plus a turnout dataframe which is a subset of the election data.
...
The election data includes:
  ...
  - date
  - party name, party code (with non-primary parties grouped in major)
