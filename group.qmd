...
# Count the proportion of votes received in each area
...
### Q4 : Relationship between census and vote (urban vs. rural)
Different parties show significant differences in support between rural and urban areas. EH-BILDU and BNG has higher support in rural areas, while MP, CS and PODEMOS-IU have stronger support in urban areas.
```{r}
#| echo: false
