...
Since the code for analyzing the case when the PSOE is the first party is essentially the same as when the PP is first, I’ve decided to focus on presenting only the PP case.
