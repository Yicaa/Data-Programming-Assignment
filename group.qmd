...
Low Turnout Areas (<70.7%): Mainstream parties dominate. PP leads in vote share, followed by PSOE, while PODEMOS-IU outperforms VOX. Smaller parties remain marginal.

Extreme Low Turnout Areas (<45%): Regional nationalist parties like EAJ-PNV and EH-BILDU perform strongly, with PSOE overtaking PP. Far-left and far-right parties show limited influence.

Conclusion: Low turnout benefits mainstream parties (PP, PSOE), while extremely low turnout favors regional nationalist parties.
...
How consistent are the survey projections across different election periods? Identify trends or patterns in the prediction biases over time and analyze if certain parties consistently experience higher deviations.
...
1.Variation in Prediction Bias Across Parties:
Certain parties, such as VOX and PODEMOS-IU, show significant fluctuations in prediction bias, with deviations reaching up to ±10%. These fluctuations suggest that survey projections for these parties have been less consistent over time.
Conversely, major parties such as PP and PSOE exhibit relatively stable prediction biases close to zero, indicating higher reliability in survey projections.

2.Time-Dependent Trends:
Between 2010 and 2020, biases for VOX and PODEMOS-IU are more pronounced during specific election cycles, such as around 2015 and 2020. This indicates potential methodological challenges during these periods in accurately capturing voter intentions for these parties.
Parties like CS, ERC, and EAJ-PNV show minimal changes over time, suggesting better alignment between survey projections and election results.

3.Overestimation vs. Underestimation:
VOX frequently experiences underestimation in surveys, especially in later years like 2020.
PODEMOS-IU exhibits consistent overestimation, particularly during elections around 2015 and 2020.

4.Smaller Parties' Challenges:
Regional or smaller parties, such as BNG, EH-BILDU, and CIU, also demonstrate mild biases but are less volatile compared to newer or emerging parties like VOX.
